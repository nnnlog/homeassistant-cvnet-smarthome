...
class HeatingDeviceApi:
    @staticmethod
    async def set_heating_state(socket: ClientWebSocketResponse, config: CvnetConfig, device_type: DeviceType, remote_tcp_addr: str, number: int, onoff: bool, target_temperature: float):
